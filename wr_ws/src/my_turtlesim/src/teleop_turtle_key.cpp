...
// #define KEYCODE_RIGHT 0x69
// #define KEYCODE_LEFT 0x70
// #define KEYCODE_UP 0x71
...
//         if (buffer.Event.KeyEvent.wVirtualKeyCode == 0x49)  //VK_LEFT)
//         {
//           *c = KEYCODE_LEFT;
//           return;
//         }
//         else if (buffer.Event.KeyEvent.wVirtualKeyCode == 0x4a) //VK_UP)
//         {
//           *c = KEYCODE_UP;
//           return;
//         }
//         else if (buffer.Event.KeyEvent.wVirtualKeyCode == 0x4b) //VK_RIGHT)
//         {
//           *c = KEYCODE_RIGHT;
//           return;
//         }
//         else if (buffer.Event.KeyEvent.wVirtualKeyCode == 0x4c) //VK_DOWN)
//         {
//           *c = KEYCODE_DOWN;
//           return;
//         }
...
{
public:
  KeyboardReader()  // constructor of the Node's name
  : Node("keyboard_reader"), count_(0)
  {
    publisher_ = this->create_publisher<std_msgs::msg::String>("topic", 10);
    timer_ = this->create_wall_timer(
      500ms, std::bind(&KeyboardReader::timer_callback, this));
  }
